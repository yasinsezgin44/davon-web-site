          ...
          <section className="relative pt-32 pb-20 px-4 overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 text-center">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                We Are Here to Support You For Better Healthcare Services. With our experience and innovative approach,
                we are here to develop, improve, and carry your institution into the future.
              </p>
            </div>
          </section>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                  <div className="lg:w-1/2">
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed">
                      ...
                      deliver operational excellence to their patients. Our CMMS and EAM solutions are specifically
                      designed for the unique challenges of healthcare environments.
                    </p>
                  </div>
              ...
              <div className="container mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center p-8 bg-slate-50 rounded-2xl">
                    ...
                    <p className="text-slate-600">
                      Our core values include reliability, continuous innovation, and customer focus. At Davon, we aim
                      to contribute to the success of institutions by providing reliable solutions and building
