          ...
          <section className="relative pt-32 pb-20 px-4 overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 text-center">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Pioneering the future of healthcare technology through continuous innovation, research, and development
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                  <div className="lg:w-1/2">
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed mb-4">
                      At Davon, our R&D team works closely with healthcare professionals to understand their challenges
                      and develop solutions that make a real difference in patient care and operational efficiency.
                    </p>
                    <p className="text-lg text-slate-600 leading-relaxed">
                      We invest heavily in research and development to ensure our CMMS and EAM solutions remain at the
                      forefront of healthcare technology, incorporating the latest advances in AI, IoT, and cloud
                      computing.
                    </p>
                  </div>
                  <div className="lg:w-1/2">
