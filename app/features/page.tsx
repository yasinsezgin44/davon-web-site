              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="lg:w-1/2 text-center lg:text-left">
                  ...
                  <p className="text-xl text-white/80 leading-relaxed mb-8">
                    Davon is an innovative maintenance management system specifically developed for technical teams in
                    the Healthcare sector. It provides tailored solutions by supporting all processes related to your
                    assets in the hospital environment.
                  </p>
