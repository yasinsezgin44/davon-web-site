      ...
      <main className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-20">
          ...
          <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
            ...
            >
              ...
              <p className="text-base sm:text-xl md:text-2xl text-white/80 text-balance max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 font-light">
                We are here to support you for better healthcare services. With
                our experience and innovative approach, we develop, improve, and
                carry your institution into the future.
              </p>
            </RevealOnScroll>
          </section>
          ...
          <section className="py-16 sm:py-24 px-4 relative z-10 bg-white/5">
            <div className="max-w-6xl mx-auto">
              <RevealOnScroll as="div" className="text-center mb-12 sm:mb-20">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-balance mb-4 sm:mb-6">
                  Our Core Principles
                </h2>
              ...
              >
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    Our commitment to innovation and technology ensures that
                    healthcare institutions are prepared for the future.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    We emphasize understanding our customers&apos; needs and
                    delivering value to them through healthcare-specific
                    solutions.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    Davon earns and maintains customer trust by providing
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    Davon&apos;s global presence enables healthcare institutions
                    to achieve operational excellence everywhere.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    With over 20 years of experience, our expert team delivers
                    tailored solutions for healthcare institutions&apos; needs.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    Davon supports the long-term success of both healthcare
                    institutions and the environment through sustainable
                    business practices.
                  </p>
                </div>
              </RevealOnScroll>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    As Davon, we adopt a visionary approach to provide
                    innovative solutions that ensure uninterrupted access to
                    healthcare services for patients, shape the future of
                    healthcare institutions, and support their sustainable
                    success.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    ...
                    the success of our clients and strive to achieve operational
                    excellence.
                  </p>
                </div>
                ...
                <div className="relative w-full h-96 sm:h-[500px] md:h-[600px] rounded-2xl overflow-hidden bg-gradient-to-br from-emerald-900/30 to-teal-900/30 border border-white/10 mb-16">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white/60">
                      ...
                      <p className="text-sm">
                        Global Healthcare/Global Impact Image
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <RevealOnScroll as="div">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto font-light leading-relaxed mb-8 sm:mb-12">
                  Subscribe to our email newsletter to stay updated with the
                  latest news and exclusive offers about healthcare technology
                  innovations.
                </p>
