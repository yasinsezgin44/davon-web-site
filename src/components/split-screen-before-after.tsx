...
export function SplitScreenBeforeAfter() {
  ...
  useEffect(() => {
    ...
    if (whatsappSectionRef.current)
      observer.observe(whatsappSectionRef.current);
    ...
    if (tyreKickersSectionRef.current)
      observer.observe(tyreKickersSectionRef.current);
  ...
  const getParallaxOffset = (
    ...
    const scrollProgress = Math.max(
      0,
      Math.min(1, scrollIntoSection / sectionHeight)
    );
      ...
      <div>
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-lg">
              ...
              <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Respond instantly to customer inquiries from WhatsApp,
                    Facebook Messenger, and Instagram DMs. Never leave a
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Handle unlimited inbound calls around the clock. Answer
                    questions, book test drives, and qualify leads even after
                    hours.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Engage visitors the moment they land on your site. Provide
                    instant answers about inventory, pricing, and availability
                    in real-time.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Automatically respond to email inquiries and text messages.
                    Keep conversations flowing across every channel your
                    customers prefer.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Automatically identify high-intent buyers, capture budget
                    ranges, vehicle preferences, and trade-in details before
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Schedule test drives, service appointments, and viewings
                    automatically. Sync with your calendar and send
          ...
          <div
            ...
            className="mt-16 lg:mt-24 pt-16 lg:pt-24 border-t border-slate-200"
          >
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  Clutch by Cliste handles all your WhatsApp, Messenger, and
                  Instagram DM conversations automatically. Never miss a lead,
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Respond instantly to customer inquiries across WhatsApp,
                      Facebook Messenger, and Instagram DMs. Handle unlimited
                      conversations simultaneously with consistent, professional
                      responses that book test drives and qualify leads
                      automatically.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Capture complete customer information including vehicle
                      preferences, budget range, trade-in details, and contact
                      information. Every conversation is logged with full
                      history, so your sales team always has context.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Deliver consistent, on-brand responses that enhance your
                      dealership's reputation. Customers receive instant,
                      helpful answers that feel personal and professional,
                    ...
                    <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[600px] overflow-hidden">
                      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-2 lg:py-3 flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-slate-400 text-[9px] sm:text-[10px] lg:text-xs">
                            Customer
                          </div>
                        </div>
                      </div>
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-60px)] lg:h-[calc(100%-80px)] overflow-hidden">
                        <div className="mb-2">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Hello, I'm interested in the BMW X5 you have
                              listed
                            </p>
                            <p className="text-slate-400 text-[8px] lg:text-xs mt-0.5">
                              19:00
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="mb-2 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              We're currently closed. Business hours: 9 AM - 6
                              PM. We'll respond tomorrow!
                            </p>
                            <p className="text-slate-300 text-[8px] lg:text-xs mt-0.5 text-right">
                              19:00
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[700px] overflow-hidden">
                      <div className="bg-[#0a5c4a] rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-2 lg:py-3 flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-slate-300 text-[9px] sm:text-[10px] lg:text-xs">
                            Customer
                          </div>
                        </div>
                      </div>
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-60px)] lg:h-[calc(100%-80px)] overflow-y-auto scrollbar-hide">
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Hi John! Thanks for your interest in the BMW X5.
                              I'd be happy to schedule a test drive. 🚗
                            </p>
                            <p className="text-slate-300 text-[8px] lg:text-xs mt-0.5 text-right">
                              19:00
                            </p>
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              I have availability tomorrow at 10am, 2pm, or 4pm.
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Perfect! I've booked you for 2pm tomorrow. The BMW
                              X5 is €45,900. 2023 model, 15,000km. Financing
                              options?
                            </p>
                            <p className="text-slate-300 text-[8px] lg:text-xs mt-0.5 text-right">
                              19:02
                        ...
                        <div className="flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              We accept trade-ins. What vehicle do you have? I
                              can give you an instant estimate. 💰
                            </p>
                            <p className="text-slate-300 text-[8px] lg:text-xs mt-0.5 text-right">
                              19:03
                            </p>
            ...
            >
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                      <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[700px] overflow-hidden">
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-4 sm:py-5 lg:py-8 text-center border-b border-slate-700">
                          ...
                          <div className="text-white font-bold text-xs sm:text-sm lg:text-lg mb-1">
                            Sarah Mitchell
                          </div>
                        ...
                        <div className="bg-slate-900 rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-140px)] lg:h-[calc(100%-200px)] overflow-hidden flex flex-col">
                          ...
                          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-2 lg:p-3 mb-2 lg:mb-3">
                            ...
                            <div className="text-slate-400 text-[8px] sm:text-[9px] lg:text-xs italic leading-relaxed">
                              "Hi, you've reached Premium Motors. We're
                              currently closed. Please leave a message..."
                            </div>
                          </div>
                      ...
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-140px)] lg:h-[calc(100%-200px)] overflow-y-auto scrollbar-hide space-y-2 lg:space-y-3">
                        <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 rounded-xl p-2 sm:p-3 lg:p-4 border border-slate-700">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="ml-auto text-slate-400 text-[9px] lg:text-xs font-mono">
                              02:34
                            </span>
                          </div>
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-2 sm:p-3 lg:p-4 border border-slate-700/50">
                          ...
                          <div className="space-y-2 lg:space-y-3 text-[8px] sm:text-[9px] lg:text-xs">
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-orange-400 font-semibold mb-0.5">
                                Cliste
                              </div>
                              <div className="text-slate-300 leading-relaxed">
                                "The Audi A4 is available. Would you like to
                            ...
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-blue-500">
                              ...
                              <div className="text-slate-300 leading-relaxed">
                                "Yes please! What times do you have available
                                this week?"
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              ...
                              <div className="text-slate-300 leading-relaxed">
                                "I have tomorrow at 11am, Thursday at 3pm, or
                                Friday at 10am..."
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-blue-500">
                              ...
                              <div className="text-slate-300 leading-relaxed">
                                "Thursday at 3pm works perfectly. What's the
                                price on that model?"
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              ...
                              <div className="text-slate-300 leading-relaxed">
                                "The Audi A4 is priced at €32,500. It's a 2023
                                model with 12,000km. Would you like to discuss
                                financing options?"
                              </div>
                            </div>
                          </div>
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Never miss a lead with intelligent phone automation that
                    handles unlimited calls around the clock. Book test drives,
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Answer every call instantly with natural-sounding
                        conversations that understand your inventory, pricing,
                        and availability. Never lose a customer to voicemail
                        again.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Book test drives, answer vehicle questions, provide
                        pricing, and handle trade-in inquiries through natural
                        phone conversations that feel completely human.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Get real-time insights on every call including customer
                        intent, budget range, and vehicle preferences. Your
                        sales team receives warm leads ready to close.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div
              ...
              className="mt-12 lg:mt-16 pt-12 lg:pt-16 border-t border-slate-200"
            >
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div
                  className={`transition-all duration-1000 ease-out ${
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Handle service appointments and parts inquiries
                    automatically across all your sales channels - website,
                    phone, and social media. Clutch By Cliste manages bookings,
                    answers parts questions, and processes orders seamlessly,
                    all customized to your dealership's operations.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By Cliste automatically schedules service
                        appointments and sends confirmations across all channels
                        - website, phone, and social media, customized to your
                        workflow
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Answers questions about parts availability, pricing, and
                        delivery times based on your inventory in real-time,
                        whether customers reach out via phone, website, or
                        social media
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Processes parts orders and provides tracking updates
                        without human intervention across every customer
                        touchpoint, tailored to your systems
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Keeps customers informed about service progress and
                        parts arrival status 24/7 in real-time across messaging,
                        or getting push notifications, all customized to your
                        communication style
                      </p>
                    </div>
                  </div>
                        ...
                        <div className="p-6 space-y-4 bg-slate-50 h-[500px] overflow-hidden">
                            ...
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  I'd be happy to help! What type of service do
                                  you need? We have slots available this week.
                                </p>
                              </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">
                                  Full service. Also, do you have brake pads in
                                  stock?
                                </p>
                              </div>
                              <span className="text-xs text-slate-400 mt-1 block">
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Yes! We have brake pads in stock. I can book
                                  you in for Thursday at 2 PM and include the
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  I've added an oil filter (#GF35) to your
                                  order. Your appointment is confirmed for
                        ...
                        <div className="p-6 space-y-4 bg-slate-50 h-[500px] overflow-hidden">
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  The BMW has a fresh NCT valid until March
                                  2026. Full service history available!
                                </p>
                              </div>
                              <span className="text-xs text-slate-400 mt-1">
                                14:23
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  45,000 miles with full dealer service history.
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Yes! We offer competitive trade-in values.
                                  What vehicle are you looking to trade?
                                </p>
                              </div>
                              <span className="text-xs text-slate-400 mt-1">
                                14:25
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Stop wasting time on repetitive questions. Clutch By Cliste
                    instantly answers common inquiries about NCT, mileage,
                    trade-ins, and pricing while qualifying serious buyers -
                    across your website widget, phone calls, and social media
                    channels, all tailored to your dealership's specific needs.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By Cliste responds to 50+ common questions about
                        NCT, mileage, trade-ins, and pricing instantly across
                        your website, phone, and social channels
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Automatically filters serious buyers from browsers by
                        asking the right questions tailored to your dealership
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Stop answering the same questions repeatedly - let
                        Clutch By Cliste handle the tire kickers
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Never miss a serious inquiry while filtering out
                        time-wasters around the clock - on every channel
                      </p>
                    </div>
                  </div>
                </div>
